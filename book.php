...
const razorpayOptions = {
    "key": "rzp_test_0q5X4I3lg3uT9I", // Your Razorpay Key ID
    ...
    "handler": function (response){
            ...
            // Send payment ID to server for validation
            validatePayment(response.razorpay_payment_id);
        },
...
function validatePayment(paymentId) {
        // Call your backend server to validate payment here
        fetch("http://localhost/purple-website/book.php", {
            method: "POST",
...
// Load cart items when the page loads on book.php page
if (window.location.pathname.includes("book.php")) {
    loadCartItems();
}

// Toggle between cart and booking sections
